...
const angleLeft =  require("../assets/images/angle_left.png");
const angleRight =  require("../assets/images/angle_right.png");
...
export default window.MicrositeCarousel = MicrositeCarousel;
